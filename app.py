...
def main():
    load_dotenv()
    st.set_page_config(page_title="Get insights from Books",
                       page_icon=":books:")
...
#     st.header("Get insights directly from :books:")
#     user_question = st.text_input("Ask a question about the documents or books you uploaded:")
#     if user_question:
#         handle_userinput(user_question)
...
#                 # analyze tone
#                 tone = analyze_tone(raw_text)
#                 st.write(f"The tone of the uploaded documents is: {tone}")
